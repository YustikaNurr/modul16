...
@section('content')
    <div class="container-fluid d-flex justify-content-center align-items-center"
        style="height: 100vh; background: linear-gradient(to bottom, #4a90e2, #007BFF);">
        <div class="card p-4 shadow" style="width: 100%; max-width: 400px; border-radius: 10px;">
            <div class="text-center mb-3">
                <img class="img-thumbnail" src="{{ Vite::asset('resources/images/logo.jpg') }}" alt="image" style="width: 80px; height: auto;">
            </div>
